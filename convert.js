...
console.log(BUILD.JSON & BUILD.ARTWORK)
 function Clean() {
   process.exit(0);
 }
 ...
 function removePublic(s) {
   return s.replace(/^\/?public/, '');
 }
 function saveMusicFile(input, output) {
 ...
 async function extractArtwork(input) {
